...
function PrecacheEveryThingFromKV(context)
    ...
    local zr = {
        ...
        {"model", "models/heroes/lycan/lycan_blades.vmdl"},
         --206
        {"model", "models/heroes/lycan/lycan_head.vmdl"}, --207
        {"model", "models/heroes/lycan/lycan_armor.vmdl"}, --208
        {"model", "models/heroes/lycan/lycan_fur.vmdl"},
         --209
        {"model", "models/heroes/lycan/lycan_belt.vmdl"}, --210
        --Q2 10
        {"model", "models/items/lycan/armor_royal/armor_royal.vmdl"},
         --4974
        {"model", "models/items/lycan/belt_alpha/belt_alpha.vmdl"},
         --4975
        {"model", "models/items/lycan/clawsy_greatg/clawsy_greatg.vmdl"},
         --4976
        {"model", "models/items/lycan/shoulder_alpha/shoulder_alpha.vmdl"},
         --4977
        {"model", "models/items/lycan/head_alpha/head_alpha.vmdl"},
         --4978
        --Q2 20
        {"model", "models/items/lycan/sanguinemoon_armor/sanguinemoon_armor.vmdl"}, --4859
        {"model", "models/items/lycan/sanguinemoon_shoulder/sanguinemoon_shoulder.vmdl"},
         --4860
        {"model", "models/items/lycan/sanguinemoon_weapon/sanguinemoon_weapon.vmdl"}, --4861
        {"model", "models/items/lycan/sanguinemoon_belt/sanguinemoon_belt.vmdl"},
         --4862
        ...
        --Q3 10
        {"model", "models/items/lifestealer/ravenous_head/ravenous_head.vmdl"},
         --6260
        {"model", "models/items/lifestealer/ravenous_arms/ravenous_arms.vmdl"},
         --6261
        {"model", "models/items/lifestealer/ravenous_belt/ravenous_belt.vmdl"},
         --6262
        {"model", "models/items/lifestealer/ravenous_back/ravenous_back.vmdl"},
         --6263
        --Q3 20
        {"model", "models/items/lifestealer/redrage_head/redrage_head.vmdl"},
         --6318
        {"model", "models/items/lifestealer/redrage_belt/redrage_belt.vmdl"},
         --6319
        {"model", "models/items/lifestealer/redrage_battlewings/redrage_battlewings.vmdl"},
         --6320
        {"model", "models/items/lifestealer/redrage_bracers/redrage_bracers.vmdl"},
         --6321
        --Q4 00
        --"models/heroes/faceless_void/faceless_void.vmdl"},,
        {"model", "models/heroes/faceless_void/faceless_void_weapon.vmdl"},
         --15
        {"model", "models/heroes/faceless_void/faceless_void_head.vmdl"},
         --90
        {"model", "models/heroes/faceless_void/faceless_void_shoulder.vmdl"},
         --91
        {"model", "models/heroes/faceless_void/faceless_void_bracer.vmdl"},
         --92
        {"model", "models/heroes/faceless_void/faceless_void_belt.vmdl"},
         --93
        --Q4 10
        {"model", "models/items/faceless_void/acolyte_belt/acolyte_belt.vmdl"},
         --5059
        {"model", "models/items/faceless_void/acolyte_cowl/acolyte_cowl.vmdl"},
         --5060
        {"model", "models/items/faceless_void/acolyte_gauntlet/acolyte_gauntlet.vmdl"},
         --5061
        {"model", "models/items/faceless_void/acolyte_mace/acolyte_mace.vmdl"},
         --5062
        {"model", "models/items/faceless_void/acolyte_hood/acolyte_hood.vmdl"},
         --5063
        --Q4 20
        ...
        {"model", "models/items/faceless_void/timelord_weapon/timelord_weapon.vmdl"},
         --5898
        --Q5 00
        {"model", "models/items/slark/deep_warden_scimitar/deep_warden_scimitar.vmdl"},
         --5261
        {"model", "models/items/slark/deep_warden_pauldron/deep_warden_pauldron.vmdl"},
         --5262
        {"model", "models/items/slark/deep_warden_bracer/deep_warden_bracer.vmdl"},
         --5263
        {"model", "models/items/slark/deep_warden_cape/deep_warden_cape.vmdl"},
         --5264
        {"model", "models/items/slark/deep_warden_hood/deep_warden_hood.vmdl"},
         --5265
        --Q5 10
        {"model", "models/items/slark/deepscoundrel_arms/deepscoundrel_arms.vmdl"},
         --6417
        {"model", "models/items/slark/deepscoundrel_back/deepscoundrel_back.vmdl"},
         --6418
        {"model", "models/items/slark/deepscoundrel_weapon/deepscoundrel_weapon.vmdl"},
         --6419
        {"model", "models/items/slark/deepscoundrel_shoulder/deepscoundrel_shoulder.vmdl"},
         --6420
        {"model", "models/items/slark/deepscoundrel_head/deepscoundrel_head.vmdl"},
         --6421
        --Q5 20
        {"model", "models/items/slark/dark_reef_arms/dark_reef_arms.vmdl"},
         --7710
        {"model", "models/items/slark/dark_reef_back/dark_reef_back.vmdl"},
         --7711
        {"model", "models/items/slark/dark_reef_head/dark_reef_head.vmdl"},
         --7712
        {"model", "models/items/slark/dark_reef_shoulders/dark_reef_shoulders.vmdl"},
         --7713
        {"model", "models/items/slark/dark_reef_weapon/dark_reef_weapon.vmdl"},
         --7714
        --Q5 21
        {"model", "models/items/slark/oceanconquerer_back/oceanconquerer_back.vmdl"},
         --6383
        {"model", "models/items/slark/oceanconquerer_shoulder/oceanconquerer_shoulder.vmdl"},
         --6392
        {"model", "models/items/slark/oceanconquerer_head/oceanconquerer_head.vmdl"},
         --6405
        {"model", "models/items/slark/oceanconquerer_arms/oceanconquerer_arms.vmdl"},
         --6406
        {"model", "models/items/slark/oceanconquerer_weapon/oceanconquerer_weapon.vmdl"},
         --6407
        --W1 00
        ...
        {"model", "models/heroes/huskar/huskar_spear.vmdl"},
         --268
        {"model", "models/heroes/huskar/huskar_dagger.vmdl"},
         --269
        {"model", "models/heroes/huskar/huskar_helmet.vmdl"},
         --270
        {"model", "models/heroes/huskar/huskar_shoulder.vmdl"},
         --271
        {"model", "models/heroes/huskar/huskar_bracer.vmdl"},
         --272
        --W2 10
        ...
        {"model", "models/items/huskar/sacred_bones_helmet/sacred_bones_helmet.vmdl"},
         --4909
        ...
        {"model", "models/items/huskar/obsidian_claw_of_the_jaguar_helmet/obsidian_claw_of_the_jaguar_helmet.vmdl"},
         --4300
        {"model", "models/items/huskar/obsidian_claw_of_the_jaguar_shoulder/obsidian_claw_of_the_jaguar_shoulder.vmdl"},
         --4301
        {"model", "models/items/huskar/obsidian_blade_spear/obsidian_blade_spear.vmdl"},
         --4748
        {"model", "models/items/huskar/obsidian_claw_of_the_jaguar_dagger/obsidian_claw_of_the_jaguar_dagger.vmdl"},
         --4749
        ...
        --W3 10
        {"model", "models/items/clinkz/clinkz_weapon_goc/clinkz_weapon_goc.vmdl"},
         --4741
        ...
        {"model", "models/items/clinkz/clinkz_hands_goc/clinkz_hands_goc.vmdl"},
         --4972
        {"model", "models/items/clinkz/clinkz_back_goc/clinkz_back_goc.vmdl"},
         --4973
        --W3 20
        {"model", "models/items/clinkz/lost_viking_back/lost_viking_back.vmdl"},
         --5151
        {"model", "models/items/clinkz/lost_viking_bow/lost_viking_bow.vmdl"},
         --5152
        {"model", "models/items/clinkz/lost_viking_gauntlet/lost_viking_gauntlet.vmdl"},
         --5153
        {"model", "models/items/clinkz/lost_viking_helmet/lost_viking_helmet.vmdl"},
         --5154
        {"model", "models/items/clinkz/lost_viking_shoulder/lost_viking_shoulder.vmdl"},
         --5155
        --W4 00 models/heroes/lanaya/lanaya.vmdl
        {"model", "models/heroes/lanaya/lanaya_hair.vmdl"},
         --173
        {"model", "models/heroes/lanaya/lanaya_cowl_shoulder.vmdl"},
         --174
        {"model", "models/heroes/lanaya/lanaya_bracers_skirt.vmdl"},
         --175
        --W4 10
        {"model", "models/items/lanaya/thiefscholar_girdle/thiefscholar_girdle.vmdl"}, --4695
        {"model", "models/items/lanaya/thiefscholar_coiffure/thiefscholar_coiffure.vmdl"},
         --4696
        {"model", "models/items/lanaya/thiefscholar_shoulder/thiefscholar_shoulder.vmdl"},
         --4697
        --W4 20
        {"model", "models/items/lanaya/ta_ns_shoulder/ta_ns_shoulder.vmdl"},
         --4668
        {"model", "models/items/lanaya/ta_ns_armor/ta_ns_armor.vmdl"},
         --4669
        {"model", "models/items/lanaya/ta_ns_head/ta_ns_head.vmdl"},
         --4670
        --W5 00 models/heroes/shadowshaman/shadowshaman.vmdl
        {"model", "models/heroes/shadowshaman/head.vmdl"},
         --251  通用
        {"model", "models/items/shadowshaman/shades_weapon/shades_weapon.vmdl"},
         --6197
        {"model", "models/items/shadowshaman/shades_offhand/shades_offhand.vmdl"},
         --6198
        {"model", "models/items/shadowshaman/shades_belt/shades_belt.vmdl"},
         --6206
        {"model", "models/items/shadowshaman/shades_arms/shades_arms.vmdl"},
         --6309
        ...
        {"model", "models/items/shadowshaman/vagabond_wand/vagabond_wand.vmdl"},
         --4416
        {"model", "models/items/shadowshaman/vagabond_hat/vagabond_hat.vmdl"},
         --4417
        {"model", "models/items/shadowshaman/vagabond_drink/vagabond_drink.vmdl"},
         --4419
        --W5 20
        {"model", "models/items/shadowshaman/tangki_offhand/tangki_offhand.vmdl"},
         --6814
        {"model", "models/items/shadowshaman/tangki_weapon/tangki_weapon.vmdl"},
         --6816
        {"model", "models/items/shadowshaman/tangki_arms/tangki_arms.vmdl"},
         --6817
        {"model", "models/items/shadowshaman/tangki_belt/tangki_belt.vmdl"},
         --6818
        {"model", "models/items/shadowshaman/tangki_head/tangki_head.vmdl"},
         --6819
        --W5 21
        {"model", "models/items/shadowshaman/eki_bukaw_bracers/eki_bukaw_bracers.vmdl"},
         --5501
        {"model", "models/items/shadowshaman/records_of_the_eki_bukaw/records_of_the_eki_bukaw.vmdl"},
         --5500
        {"model", "models/items/shadowshaman/eki_bukaw_wand__offhand/eki_bukaw_wand__offhand.vmdl"},
         --5503
        {"model", "models/items/shadowshaman/eki_bukaw_wand/eki_bukaw_wand.vmdl"},
         --5504
        {"model", "models/items/shadowshaman/visage_of_eki_bukaw/visage_of_eki_bukaw.vmdl"},
         --5548
        --E1 00 models/heroes/tiny_02/tiny_02.vmdl
        {"model", "models/heroes/tiny_01/tiny_01_body.vmdl"},
         --494
        {"model", "models/heroes/tiny_01/tiny_01_head.vmdl"},
         --493
        {"model", "models/heroes/tiny_01/tiny_01_left_arm.vmdl"},
         --495
        {"model", "models/heroes/tiny_01/tiny_01_right_arm.vmdl"},
         --496
        --E1 10
        {"model", "models/items/tiny/scarletquarry_arms/scarletquarry_arms.vmdl"},
         --6886
        {"model", "models/items/tiny/scarletquarry_offhand/scarletquarry_offhand.vmdl"},
         --6998
        {"model", "models/items/tiny/scarletquarry_head/scarletquarry_head.vmdl"},
         --6999
        {"model", "models/items/tiny/scarletquarry_armor/scarletquarry_armor.vmdl"},
         --7000
        ...
        {"model", "models/items/wraith_king/eternal_arms/eternal_arms.vmdl"},
         --6171
        ...
        {"model", "models/items/wraith_king/eternal_head/eternal_head.vmdl"},
         --6174
        {"model", "models/items/wraith_king/eternal_shoulder/eternal_shoulder.vmdl"},
         --6175
        --E3 10
        {"model", "models/items/wraith_king/regalia_of_the_wraith_lord_back/regalia_of_the_wraith_lord_back.vmdl"},
         --5052
        {"model", "models/items/wraith_king/regalia_of_the_wraith_lord_sword/regalia_of_the_wraith_lord_sword.vmdl"},
         --5053
        {"model", "models/items/wraith_king/regalia_of_the_wraith_lord_bracers/regalia_of_the_wraith_lord_bracers.vmdl"},
         --5054
        {"model", "models/items/wraith_king/regalia_of_the_wraith_lord_helmet/regalia_of_the_wraith_lord_helmet.vmdl"},
         --5055
        {
            "model",
        ...
        {"model", "models/heroes/shredder/shredder_driver_hat.vmdl"},
         --386
        {"model", "models/heroes/shredder/shredder_chainsaw.vmdl"},
         --388(注意不连贯)
        {"model", "models/heroes/shredder/shredder_shoulders.vmdl"},
         --389
        {"model", "models/heroes/shredder/shredder_body.vmdl"},
         --390
        {"model", "models/heroes/shredder/shredder_armor.vmdl"},
         --401
        {"model", "models/heroes/shredder/shredder_hook.vmdl"},
         --402
        --E4 10
        {"model", "models/items/shredder/timberthaw_armor/timberthaw_armor.vmdl"},
         --6519
        {"model", "models/items/shredder/timberthaw_weapon/timberthaw_weapon.vmdl"},
         --6520
        {"model", "models/items/shredder/timberthaw_head/timberthaw_head.vmdl"},
         --6521
        {"model", "models/items/shredder/timberthaw_offhand/timberthaw_offhand.vmdl"},
         --6522
        {"model", "models/items/shredder/timberthaw_shoulder/timberthaw_shoulder.vmdl"},
         --6523
        {"model", "models/items/shredder/timberthaw_back/timberthaw_back.vmdl"},
         --6524
        --E5 00 models/heroes/chaos_knight/chaos_knight.vmdl
        {"model", "models/items/chaos_knight/chaos_legion_mount/chaos_legion_mount.vmdl"},
         --5980
        {"model", "models/items/chaos_knight/chaos_legion_drapes/chaos_legion_drapes.vmdl"},
         --5981
        {"model", "models/items/chaos_knight/chaos_legion_helm/chaos_legion_helm.vmdl"},
         --5982
        {"model", "models/items/chaos_knight/chaos_legion_shield/chaos_legion_shield.vmdl"},
         --5983
        {"model", "models/items/chaos_knight/chaos_legion_weapon/chaos_legion_weapon.vmdl"},
         --5984
        --E5 10
        {"model", "models/items/chaos_knight/ck_esp_blade/ck_esp_blade.vmdl"},
         --5518
        {"model", "models/items/chaos_knight/ck_esp_helm/ck_esp_helm.vmdl"},
         --5519
        {"model", "models/items/chaos_knight/ck_esp_mount/ck_esp_mount.vmdl"},
         --5520
        {"model", "models/items/chaos_knight/ck_esp_shield/ck_esp_shield.vmdl"},
         --5521
        {"model", "models/items/chaos_knight/ck_esp_shoulder/ck_esp_shoulder.vmdl"},
         --5522
        --E5 11
        {"model", "models/items/chaos_knight/rising_chaos_blade/rising_chaos_blade.vmdl"},
         --5921
        {"model", "models/items/chaos_knight/rising_chaos_helm/rising_chaos_helm.vmdl"},
         --5922
        {"model", "models/items/chaos_knight/rising_chaos_spaulders/rising_chaos_spaulders.vmdl"},
         --5923
        {"model", "models/items/chaos_knight/rising_chaos_steed/rising_chaos_steed.vmdl"},
         --5924
        {"model", "models/items/chaos_knight/rising_chaos_shield/rising_chaos_shield.vmdl"},
         --5925
        --E6 00 models/heroes/nerubian_assassin/nerubian_assassin.vmdl
        {"model", "models/items/nerubian_assassin/nyx_dusky_back/nyx_dusky_back.vmdl"},
         --5567
        {"model", "models/items/nerubian_assassin/nyx_dusky_head/nyx_dusky_head.vmdl"},
         --5568
        {"model", "models/items/nerubian_assassin/nyx_dusky_misc/nyx_dusky_misc.vmdl"},
         --5569
        {"model", "models/items/nerubian_assassin/nyx_dusky_weapon/nyx_dusky_weapon.vmdl"},
         --5570
        --E6 10
        {"model", "models/items/nerubian_assassin/spines_of_the_predator/spines_of_the_predator.vmdl"},
         --5201
        {"model", "models/items/nerubian_assassin/mind_piercer_of_the_predator/mind_piercer_of_the_predator.vmdl"},
         --5202
        {"model", "models/items/nerubian_assassin/preyfinders_of_the_predator/preyfinders_of_the_predator.vmdl"},
         --5203
        {"model", "models/items/nerubian_assassin/blades_of_the_predator/blades_of_the_predator.vmdl"},
         --5204
        --E6 11 models/heroes/broodmother/broodmother.vmdl (和E6 10模型不一样)
        {"model", "models/items/broodmother/abdomen_of_perception/abdomen_of_perception.vmdl"},
         --5854
        ...
        {"model", "models/items/storm_spirit/ornate_hat_of_good_fortune/ornate_hat_of_good_fortune.vmdl"},
         --6022
        {"model", "models/items/storm_spirit/scale_pauldrons_of_good_fortune/scale_pauldrons_of_good_fortune.vmdl"},
         --6023
        --D1 10
        {"model", "models/items/storm_spirit/heavenlygeneral_armor/heavenlygeneral_armor.vmdl"},
         --6168
        {"model", "models/items/storm_spirit/heavenlygeneral_hat/heavenlygeneral_hat.vmdl"},
         --6169
        {"model", "models/items/storm_spirit/heavenlygeneral_shoulders/heavenlygeneral_shoulders.vmdl"},
         --6170
        --D2 00 models/heroes/earth_spirit/earth_spirit.vmdl
        {"model", "models/heroes/earth_spirit/earth_spirit_head.vmdl"},
         --482 通用
        {"model", "models/items/earth_spirit/demon_stone_bracers/demon_stone_bracers.vmdl"},
         --6002
        {"model", "models/items/earth_spirit/demon_stone_belt/demon_stone_belt.vmdl"},
         --6003
        ...
        --D2 10
        {"model", "models/items/earth_spirit/vanquishing_demons_arms/vanquishing_demons_arms.vmdl"},
         --6432
        {"model", "models/items/earth_spirit/vanquishing_demons_belt/vanquishing_demons_belt.vmdl"},
         --6433
        {"model", "models/items/earth_spirit/vanquishing_demons_helmet/vanquishing_demons_helmet.vmdl"},
         --6434
        {"model", "models/items/earth_spirit/vanquishing_demons_neck/vanquishing_demons_neck.vmdl"},
         --6435
        {"model", "models/items/earth_spirit/vanquishing_demons_weapon/vanquishing_demons_weapon.vmdl"},
         --6436
        ...
        {"model", "models/heroes/shadow_fiend/shadow_fiend_head.vmdl"},
         --387
        ...
        {"model", "models/heroes/medusa/medusa_bow.vmdl"},
         --381
        {"model", "models/heroes/medusa/medusa_veil.vmdl"},
         --382
        {"model", "models/heroes/medusa/medusa_torso.vmdl"},
         --383
        {"model", "models/heroes/medusa/medusa_arms.vmdl"},
         --384
        {"model", "models/heroes/medusa/medusa_tail.vmdl"},
         --385
        --D5 10
        {"model", "models/items/medusa/forsaken_beauty_arms/forsaken_beauty_arms.vmdl"},
         --5004
        {"model", "models/items/medusa/forsaken_beauty_bow/forsaken_beauty_bow.vmdl"},
         --5005
        {"model", "models/items/medusa/forsaken_beauty_chest/forsaken_beauty_chest.vmdl"},
         --5006
        {"model", "models/items/medusa/forsaken_beauty_head/forsaken_beauty_head.vmdl"},
         --5007
        {"model", "models/items/medusa/forsaken_beauty_tail/forsaken_beauty_tail.vmdl"},
         --5008
        --D6 00 models/heroes/drow/drow.vmdl
        {"model", "models/items/drow/gauntlets_of_the_boreal_watch/gauntlets_of_the_boreal_watch.vmdl"},
         --5194
        {"model", "models/items/drow/legplates_of_the_boreal_watch/legplates_of_the_boreal_watch.vmdl"},
         --5195
        {"model", "models/items/drow/longbow_of_the_boreal_watch/longbow_of_the_boreal_watch.vmdl"},
         --5196
        {"model", "models/items/drow/cowl_of_the_boreal_watch/cowl_of_the_boreal_watch.vmdl"},
         --5197
        {"model", "models/items/drow/pauldrons_of_the_boreal_watch/pauldrons_of_the_boreal_watch.vmdl"},
         --5198
        {"model", "models/items/drow/quiver_of_the_boreal_watch/quiver_of_the_boreal_watch.vmdl"},
         --5199
        {"model", "models/items/drow/cloak_of_the_boreal_watch/cloak_of_the_boreal_watch.vmdl"},
         --5120
        --D6 10
        {"model", "models/items/drow/drow_sentinel_bow/drow_sentinel_bow.vmdl"},
         --5883
        {"model", "models/items/drow/drow_sentinel_helm/drow_sentinel_helm.vmdl"},
         --5974
        {"model", "models/items/drow/drow_sentintel_legs/drow_sentintel_legs.vmdl"},
         --5975
        {"model", "models/items/drow/drow_sentinel_quiver/drow_sentinel_quiver.vmdl"},
         --5979
        {"model", "models/items/drow/drow_sentinel_shoulders/drow_sentinel_shoulders.vmdl"},
         --5985
        {"model", "models/items/drow/drow_sentinel_gloves/drow_sentinel_gloves.vmdl"},
         --5986
        {"model", "models/items/drow/drow_sentinel_cloak/drow_sentinel_cloak.vmdl"},
         --5989
        --D6 20
        {"model", "models/items/drow/black_wind_head/black_wind_head.vmdl"},
         --6552
        {"model", "models/items/drow/black_wind_arms/black_wind_arms.vmdl"},
         --6553
        {"model", "models/items/drow/black_wind_shoulders/black_wind_shoulders.vmdl"},
         --6554
        {"model", "models/items/drow/black_wind_legs/black_wind_legs.vmdl"},
         --6555
        {"model", "models/items/drow/black_wind_weapon/black_wind_weapon.vmdl"},
         --6556
        {"model", "models/items/drow/black_wind_quiver/black_wind_quiver.vmdl"},
         --6557
        {"model", "models/items/drow/black_wind_back/black_wind_back.vmdl"},
         --6558
        --F1 00
        {"model", "models/items/keeper_of_the_light/northlight_stag_mount/northlight_stag_mount.vmdl"},
         --5773
        {"model", "models/items/keeper_of_the_light/northlight_staff/northlight_staff.vmdl"},
         --5772
        {"model", "models/items/keeper_of_the_light/northlight_head/northlight_head.vmdl"},
         --5771
        {"model", "models/items/keeper_of_the_light/northlight_belt/northlight_belt.vmdl"},
         --5770
        {"model", "models/items/keeper_of_the_light/northlight_armor/northlight_armor.vmdl"},
         --5769
        --F1 10
        {"model", "models/items/keeper_of_the_light/horse_roehringods/horse_roehringods.vmdl"},
         --4867
        {"model", "models/items/keeper_of_the_light/weapon_staffgods/weapon_staffgods.vmdl"},
         --4865
        {"model", "models/items/keeper_of_the_light/head_hoodgodsv3/head_hoodgodsv3.vmdl"},
         --4868
        {"model", "models/items/keeper_of_the_light/belt_skirtgodsv2/belt_skirtgodsv2.vmdl"},
         --4866
        {"model", "models/items/keeper_of_the_light/armor_armorgodsv3/armor_armorgodsv3.vmdl"},
         --4864
        --F1 20
        {"model", "models/items/keeper_of_the_light/cradle_of_lights_mount/cradle_of_lights_mount.vmdl"},
         --7676
        {"model", "models/items/keeper_of_the_light/cradle_of_lights_weapon/cradle_of_lights_weapon.vmdl"},
         --7677
        {"model", "models/items/keeper_of_the_light/cradle_of_lights_head/cradle_of_lights_head.vmdl"},
         --7679
        {"model", "models/items/keeper_of_the_light/cradle_of_lights_belt/cradle_of_lights_belt.vmdl"},
         --7678
        {"model", "models/items/keeper_of_the_light/cradle_of_lights_armor/cradle_of_lights_armor.vmdl"},
         --7675
        --F2  00
        {"model", "models/items/lich/imperialists_mana_chamber/imperialists_mana_chamber.vmdl"},
         --7065
        {"model", "models/items/lich/imperialists_guardian_lions/imperialists_guardian_lions.vmdl"},
         --7064
        {"model", "models/items/lich/imperialists_runed_bracers/imperialists_runed_bracers.vmdl"},
         --7066
        {"model", "models/items/lich/imperialists_cape_of_the_twin_dragons/imperialists_cape_of_the_twin_dragons.vmdl"},
         --6949
        {"model", "models/items/lich/imperialists_frost_biter/imperialists_frost_biter.vmdl"},
         --7063
        --F2  10
        {"model", "models/items/lich/the_deadwinter_sash/the_deadwinter_sash.vmdl"},
         --4853
        {"model", "models/items/lich/the_deadwinter_head/the_deadwinter_head.vmdl"},
         --4851
        {"model", "models/items/lich/the_deadwinter_arms/the_deadwinter_arms.vmdl"},
         --4854
        {"model", "models/items/lich/the_deadwinter_back/the_deadwinter_back.vmdl"},
         --4852
        --F3 00
        {"model", "models/items/witchdoctor/tale_tellers_hairhat.vmdl"},
         --4254
        {"model", "models/items/witchdoctor/tale_tellers_poncho.vmdl"},
         --4253
        {"model", "models/items/witchdoctor/tale_tellers_dress.vmdl"},
         --4251
        {"model", "models/items/witchdoctor/witchstaff_weapon/witchstaff_weapon.vmdl"}, --6577
        {"model", "models/items/witchdoctor/tale_tellers_drum.vmdl"},
         --4252
        --F3 10
        {"model", "models/items/witchdoctor/purplenightmare_head/purplenightmare_head.vmdl"},
         --6954
        {"model", "models/items/witchdoctor/purplenightmare_shoulder/purplenightmare_shoulder.vmdl"},
         --6951
        {"model", "models/items/witchdoctor/purplenightmare_belt/purplenightmare_belt.vmdl"},
         --6955
        {"model", "models/items/witchdoctor/purplenightmare_weapon/purplenightmare_weapon.vmdl"},
         --6956
        {"model", "models/items/witchdoctor/purplenightmare_back/purplenightmare_back.vmdl"},
         --6953
        --F3 11
        {"model", "models/items/witchdoctor/voodoo_skullmask.vmdl"},
         --4222
        {"model", "models/heroes/witchdoctor/witchdoctor_bag.vmdl"},
         --95
        {"model", "models/items/witchdoctor/voodoo_belt.vmdl"},
         --4096
        {"model", "models/items/witchdoctor/voodo_staff.vmdl"},
         --4221
        {"model", "models/items/witchdoctor/voodoo_backpack.vmdl"},
         --4220
        --F4 00
        {"model", "models/items/necrolyte/heretic_weapon/heretic_weapon.vmdl"}, --6379
        {"model", "models/items/necrolyte/heretic_head/heretic_head.vmdl"},
         --6377
        {"model", "models/items/necrolyte/heretic_hood/heretic_hood.vmdl"},
         --6378
        {"model", "models/items/necrolyte/heretic_shoulder/heretic_shoulder.vmdl"},
         --6380
        --F4 10
        ...
        {"model", "models/items/necrolyte/necronub_top/necronub_top.vmdl"},
         --7083
        {"model", "models/items/necrolyte/necronub_wings/necronub_wings.vmdl"},
         --7124
        --F4 11
        {"model", "models/items/necrolyte/immemorial_emperor_weapon/immemorial_emperor_weapon.vmdl"},
         --6054
        {"model", "models/items/necrolyte/immemorial_emperor_beard/immemorial_emperor_beard.vmdl"},
         --6051
        {"model", "models/items/necrolyte/immemorial_emperor_head/immemorial_emperor_head.vmdl"},
         --6052
        {"model", "models/items/necrolyte/immemorial_emperor_shoulder/immemorial_emperor_shoulder.vmdl"},
         --6053
        --F5 00
        {"model", "models/items/vengefulspirit/banished_princess_head/banished_princess_head.vmdl"},
         --6516
        {"model", "models/items/vengefulspirit/banished_princess_weapon/banished_princess_weapon.vmdl"},
         --6518
        {"model", "models/items/vengefulspirit/banished_princess_cape/banished_princess_cape.vmdl"},
         --6515
        {"model", "models/items/vengefulspirit/banished_princess_legs/banished_princess_legs.vmdl"},
         --6517
        -- --F5 10
        ...
        {"model", "models/items/vengefulspirit/huangs_umbra_weapon/huangs_umbra_weapon.vmdl"},
         --7798
        {"model", "models/items/vengefulspirit/huangs_umbra_shoulders/huangs_umbra_shoulders.vmdl"}, --7799
        {"model", "models/items/vengefulspirit/huangs_umbra_skirt/huangs_umbra_skirt.vmdl"},
         --7796
        --R1 00
        {"model", "models/items/puck/mischievous_back/mischievous_back.vmdl"}, --6166
        {"model", "models/items/puck/mischievous_tail/mischievous_tail.vmdl"},
         --6165
        {"model", "models/items/puck/mischievous_head/mischievous_head.vmdl"},
         --6167
        --R1 10
        {"model", "models/items/puck/reminiscence_wings/reminiscence_wings.vmdl"}, --6711
        {"model", "models/items/puck/reminiscence_tail/reminiscence_tail.vmdl"},
         --6710
        ...
        {"model", "models/items/puck/mysticcoils_tail/mysticcoils_tail.vmdl"},
         --6176
        {"model", "models/items/puck/mysticcoils_antennae/mysticcoils_antennae.vmdl"},
         --6178
        --R3 00
        {"model", "models/heroes/winterwyvern/winterwyvern_backitem.vmdl"}, --552
        {"model", "models/heroes/winterwyvern/winterwyvern_crown.vmdl"},
         --551
        --R5 00
        {"model", "models/items/obsidian_destroyer/head_arcanef/head_arcanef.vmdl"}, --4641
        {"model", "models/items/obsidian_destroyer/armor_bacon/armor_bacon.vmdl"},
         --4586
        {"model", "models/items/obsidian_destroyer/weapon_arcane_obliva/weapon_arcane_obliva.vmdl"},
         --4642
        {"model", "models/items/obsidian_destroyer/back_baconator_d/back_baconator_d.vmdl"},
         --4587
        ...
        {"model", "models/items/obsidian_destroyer/dragon_forged_wings/dragon_forged_wings.vmdl"},
         --5211
        {"model", "models/heroes/obsidian_destroyer/obsidian_destroyer_head.vmdl"},
         --226
        {"model", "models/items/obsidian_destroyer/dragon_forged_stare/dragon_forged_stare.vmdl"},
         --5209
        {"model", "models/items/obsidian_destroyer/dragon_forged_armor/dragon_forged_armor.vmdl"},
         --5208
        --hire 12
        ...
        --D7 00
        {"model", "models/heroes/tuskarr/tusk_weapon.vmdl"},
         --417
        {"model", "models/heroes/tuskarr/tusk_hat.vmdl"},
         --415
        {"model", "models/heroes/tuskarr/tusk_fish_basket.vmdl"},
         --418
        {"model", "models/heroes/tuskarr/tusk_horns.vmdl"},
         --416
        {"model", "models/heroes/tuskarr/tusk_cowl.vmdl"},
         --414
        {"model", "models/heroes/tuskarr/tusk_armor_glove.vmdl"},
         --413
        --D7 10
        {"model", "models/items/tuskarr/onizaphk_ahunter_armsv2/onizaphk_ahunter_armsv2.vmdl"}, --4499
        {"model", "models/items/tuskarr/onizaphk_ahunter_back/onizaphk_ahunter_back.vmdl"},
         --4498
        {"model", "models/items/tuskarr/onizaphk_ahunter_head/onizaphk_ahunter_head.vmdl"},
         --4460
        {"model", "models/items/tuskarr/onizaphk_ahunter_neck/onizaphk_ahunter_neck.vmdl"},
         --4441
        {"model", "models/items/tuskarr/onizaphk_ahunter_shoulder/onizaphk_ahunter_shoulder.vmdl"},
         --4123
        {"model", "models/items/tuskarr/onizaphk_ahunter_weapon/onizaphk_ahunter_weapon.vmdl"},
         --4097
        --D7 11
        {"model", "models/items/tuskarr/glaciomarine_arm/glaciomarine_arm.vmdl"},
         --9010
        {"model", "models/items/tuskarr/glaciomarine_back/glaciomarine_back.vmdl"},
         --9011
        {"model", "models/items/tuskarr/glaciomarine_head/glaciomarine_head.vmdl"},
         --9007
        {"model", "models/items/tuskarr/glaciomarine_neck/glaciomarine_neck.vmdl"},
         --9008
        {"model", "models/items/tuskarr/glaciomarine_shoulder/glaciomarine_shoulder.vmdl"},
         --9012
        {"model", "models/items/tuskarr/glaciomarine_weapon/glaciomarine_weapon.vmdl"},
         --9009
        --Q6 00
        {"model", "models/heroes/luna/luna_head.vmdl"},
         --453
        {"model", "models/heroes/luna/luna_mount.vmdl"},
         --452
        {"model", "models/heroes/luna/luna_shoulder.vmdl"},
         --451
        {"model", "models/heroes/luna/luna_shield.vmdl"},
         --449
        {"model", "models/heroes/luna/luna_helmet.vmdl"},
         --450
        {"model", "models/heroes/luna/luna_weapon.vmdl"},
         --448
        --Q6 10
        {"model", "models/items/luna/selemenes_eclipse_helm/selemenes_eclipse_helm.vmdl"},
         --7701
        {"model", "models/items/luna/selemenes_eclipse_mount/selemenes_eclipse_mount.vmdl"},
         --7703
        {"model", "models/items/luna/selemenes_eclipse_shield/selemenes_eclipse_shield.vmdl"},
         --7700
        {"model", "models/items/luna/selemenes_eclipse_shoulders/selemenes_eclipse_shoulders.vmdl"},
         --7702
        {"model", "models/items/luna/selemenes_eclipse_weapon/selemenes_eclipse_weapon.vmdl"},
         --7699
        --Q6 20
        {"model", "models/items/luna/lucent_epaulets/lucent_epaulets.vmdl"},
         --5944
        {"model", "models/items/luna/lucent_glaive/lucent_glaive.vmdl"},
         --5945
        {"model", "models/items/luna/lucent_guard/lucent_guard.vmdl"},
         --5946
        {"model", "models/items/luna/lucent_head/lucent_head.vmdl"},
         --5948
        {"model", "models/items/luna/lucent_mount/lucent_mount.vmdl"},
         --5947
        --Q6 21
        {"model", "models/items/mirana/crescent_bow/crescent_bow.vmdl"},
         --6658
        {"model", "models/items/mirana/crescent_back/crescent_back.vmdl"},
         --6657
        {"model", "models/items/mirana/crescent_bracers/crescent_bracers.vmdl"},
         --6659
        {"model", "models/items/mirana/crescent_hair/crescent_hair.vmdl"},
         --6660
        {"model", "models/items/mirana/crescent_mount/crescent_mount.vmdl"},
         --6661
        {"model", "models/items/mirana/crescent_quiver/crescent_quiver.vmdl"},
         --6662
        {"model", "models/items/mirana/crescent_shoulder/crescent_shoulder.vmdl"},
         --6663
        --General 1
        {"model", "models/items/legion_commander/battlefield_weapon/battlefield_weapon.vmdl"},
         --6827
        {"model", "models/items/legion_commander/battlefield_head/battlefield_head.vmdl"},
         --6861
        {"model", "models/items/legion_commander/battlefield_back/battlefield_back.vmdl"},
         --6829
        {"model", "models/items/legion_commander/battlefield_shoulder/battlefield_shoulder.vmdl"},
         --6828
        {"model", "models/items/legion_commander/battlefield_arms/battlefield_arms.vmdl"},
         --6834
        --General 2
        {"model", "models/items/legion_commander/immortalspride_weapon/immortalspride_weapon.vmdl"},
         --6995
        {"model", "models/items/legion_commander/immortalspride_head/immortalspride_head.vmdl"},
         --6994
        {"model", "models/items/legion_commander/immortalspride_back/immortalspride_back.vmdl"},
         --6909
        {"model", "models/items/legion_commander/immortalspride_shoulder/immortalspride_shoulder.vmdl"},
         --7008
        {"model", "models/items/legion_commander/immortalspride_arms/immortalspride_arms.vmdl"},
         --6910
        --General 3
        {"model", "models/items/legion_commander/spear_of_the_dragon_guard/spear_of_the_dragon_guard.vmdl"},
         --6035
        {"model", "models/items/legion_commander/plume_of_the_dragon_guard/plume_of_the_dragon_guard.vmdl"},
         --6031
        {"model", "models/items/legion_commander/twin_dragon_banner/twin_dragon_banner.vmdl"},
         --6034
        {"model", "models/items/legion_commander/scales_of_the_dragon_guard/scales_of_the_dragon_guard.vmdl"},
         --6032
        {"model", "models/items/legion_commander/armlet_of_the_dragon_guard/armlet_of_the_dragon_guard.vmdl"},
         --6033
        --General 4
        {"model", "models/items/legion_commander/valkyrie_weapon/valkyrie_weapon.vmdl"},
         --6244
        {"model", "models/items/legion_commander/valkyrie_head/valkyrie_head.vmdl"},
         --6243
        {"model", "models/items/legion_commander/valkyrie_back/valkyrie_back.vmdl"},
         --6242
        {"model", "models/items/legion_commander/valkyrie_shoulder/valkyrie_shoulder.vmdl"},
         --6240
        {"model", "models/items/legion_commander/valkyrie_arms/valkyrie_arms.vmdl"},
         --6241
        --General 5
        {"model", "models/items/legion_commander/errant_spear/errant_spear.vmdl"},
         --7224
        {"model", "models/items/legion_commander/errant_cowl/errant_cowl.vmdl"},
         --7222
        {"model", "models/items/legion_commander/errant_standards/errant_standards.vmdl"},
         --7221
        {"model", "models/items/legion_commander/errant_pauldrons/errant_pauldrons.vmdl"},
         --7223
        {"model", "models/items/legion_commander/errant_bracers/errant_bracers.vmdl"},
         --7220
        --General 6
        {"model", "models/items/legion_commander/stonehall_weapon/stonehall_weapon.vmdl"},
         --5890
        {"model", "models/items/legion_commander/stonehall_head/stonehall_head.vmdl"},
         --5887
        {"model", "models/items/legion_commander/stonehall_back/stonehall_back.vmdl"},
         --5886
        {"model", "models/items/legion_commander/stonehall_shoulder/stonehall_shoulder.vmdl"},
         --5889
        {"model", "models/items/legion_commander/stonehall_arms/stonehall_arms.vmdl"},
         --5885
        --F6 00
        {"model", "models/items/crystal_maiden/warden_icewrack_arms/warden_icewrack_arms.vmdl"},
         --9324
        {"model", "models/items/crystal_maiden/warden_icewrack_back/warden_icewrack_back.vmdl"},
         --9325
        {"model", "models/items/crystal_maiden/warden_icewrack_head/warden_icewrack_head.vmdl"},
         --9327
        {"model", "models/items/crystal_maiden/warden_icewrack_shoulder/warden_icewrack_shoulder.vmdl"},
         --9326
        {"model", "models/items/crystal_maiden/warden_icewrack_staff/warden_icewrack_staff.vmdl"},
         --9328
        --F6 10
        {"model", "models/items/crystal_maiden/crystalline_comet_weapon/crystalline_comet_weapon.vmdl"},
         --6769
        {"model", "models/items/crystal_maiden/belle_arms_bracers/belle_arms_bracers.vmdl"},
         --4420
        {"model", "models/items/crystal_maiden/belle_head_hair/belle_head_hair.vmdl"},
         --4540
        {"model", "models/items/crystal_maiden/belle_shoulders/belle_shoulders.vmdl"},
         --4389
        {"model", "models/items/crystal_maiden/polarisbelle_cape/polarisbelle_cape.vmdl"},
         --4386
        --F6 11
        {"model", "models/heroes/crystal_maiden/crystal_maiden_arcana_back.vmdl"},
         --7385
        {"model", "models/items/crystal_maiden/frostbringer_hair/frostbringer_hair.vmdl"},
         --8456
        {"model", "models/items/crystal_maiden/frostbringer_shoulders/frostbringer_shoulders.vmdl"},
         --8450
        {"model", "models/items/crystal_maiden/frostbringer_sleeves/frostbringer_sleeves.vmdl"},
         --8448
        {"model", "models/items/crystal_maiden/frostbringer_staff/frostbringer_staff.vmdl"},
         --8449
        --E7 00
        {"model", "models/items/slardar/royal_guard_armplates/royal_guard_armplates.vmdl"},
         --5071
        {"model", "models/items/slardar/royal_guard_skullguard/royal_guard_skullguard.vmdl"},
         --5073
        {"model", "models/items/slardar/royal_guard_spine/royal_guard_spine.vmdl"},
         --5072
        {"model", "models/items/slardar/royal_guard_trident/royal_guard_trident.vmdl"},
         --5074
        --E7 10
        {"model", "models/items/slardar/sea_devil_back/sea_devil_back.vmdl"},
         --8133
        {"model", "models/items/slardar/sea_devil_bracers/sea_devil_bracers.vmdl"},
         --7857
        {"model", "models/items/slardar/sea_devil_head/sea_devil_head.vmdl"},
         --7858
        {"model", "models/items/slardar/sea_devil_weapon/sea_devil_weapon.vmdl"},
         --7859
        --E7 11
        {"model", "models/items/slardar/sea_dragon_arm/sea_dragon_arm.vmdl"},
         --4923
        {"model", "models/items/slardar/sea_dragon_back/sea_dragon_back.vmdl"},
         --4924
        {"model", "models/items/slardar/sea_dragon_helmet/sea_dragon_helmet.vmdl"},
         --4922
        {"model", "models/items/slardar/sea_dragon_weapon/sea_dragon_weapon.vmdl"},
         --4921
        --G5 00
        {"model", "models/items/centaur/warstomp_weapon/warstomp_weapon.vmdl"},
         --6311
        {"model", "models/items/centaur/warstomp_head/warstomp_head.vmdl"},
         --6210
        {"model", "models/items/centaur/warstomp_armor/warstomp_armor.vmdl"},
         --6312
        {"model", "models/items/centaur/warstomp_belt/warstomp_belt.vmdl"},
         --6211
        {"model", "models/items/centaur/warstomp_arms/warstomp_arms.vmdl"},
         --6207
        {"model", "models/items/centaur/warstomp_back/warstomp_back.vmdl"},
         --6209
        {"model", "models/items/centaur/warstomp_tail/warstomp_tail.vmdl"},
         --6208
        --G5 10
        {"model", "models/items/centaur/dc_weaponbsk/dc_weaponbsk.vmdl"},
         --6500
        {"model", "models/items/centaur/dc_headitembsrk/dc_headitembsrk.vmdl"},
         --6497
        {"model", "models/items/centaur/dc_shoulderbsrk/dc_shoulderbsrk.vmdl"},
         --6494
        {"model", "models/items/centaur/dc_beltbsrk/dc_beltbsrk.vmdl"},
         --6495
        {"model", "models/items/centaur/dc_armsbsrk/dc_armsbsrk.vmdl"},
         --6496
        {"model", "models/items/centaur/dc_shieldbsrk/dc_shieldbsrk.vmdl"},
         --6889
        {"model", "models/items/centaur/dc_tailbsrk/dc_tailbsrk.vmdl"},
         --6498
        --G5 11
        {"model", "models/items/centaur/warlordofhell_weapon/warlordofhell_weapon.vmdl"},
         --6962
        {"model", "models/items/centaur/warlordofhell_head/warlordofhell_head.vmdl"},
         --6958
        {"model", "models/items/centaur/warlordofhell_shoulder/warlordofhell_shoulder.vmdl"},
         --6961
        {"model", "models/items/centaur/warlordofhell_belt/warlordofhell_belt.vmdl"},
         --6960
        {"model", "models/items/centaur/warlordofhell_arms/warlordofhell_arms.vmdl"},
         --6959
        {"model", "models/items/centaur/warlordofhell_back/warlordofhell_back.vmdl"},
         --6964
        {"model", "models/items/centaur/warlordofhell_tail/warlordofhell_tail.vmdl"},
         --6963
        --Q7 00
        ...
        {"model", "models/heroes/meepo/tail.vmdl"},
         --300
        --Q7 10
        {"model", "models/items/meepo/riftshadow_roamer_pan/riftshadow_roamer_pan.vmdl"},
         --4423
        {"model", "models/items/meepo/riftshadow_roamer_hat/riftshadow_roamer_hat.vmdl"},
         --4427
        {"model", "models/items/meepo/riftshadow_roamer_vest/riftshadow_roamer_vest.vmdl"},
         --4421
        {"model", "models/items/meepo/riftshadow_roamer_pack/riftshadow_roamer_pack.vmdl"},
         --4344
        {"model", "models/items/meepo/riftshadow_roamer_gloves/riftshadow_roamer_gloves.vmdl"},
         --4434
        --300

        --Q7 20
        {"model", "models/items/meepo/dosa_weapon/dosa_weapon.vmdl"},
         --6230
        {"model", "models/items/meepo/dosa_hat/dosa_hat.vmdl"},
         --6238
        {"model", "models/items/meepo/dosa_shoulder/dosa_shoulder.vmdl"},
         --6228
        {"model", "models/items/meepo/dosa_back/dosa_back.vmdl"},
         --6237
        {"model", "models/items/dark_seer/gombangdae_arms/gombangdae_arms.vmdl"},
         --6231
        {"model", "models/items/meepo/dosa_tail/dosa_tail.vmdl"},
         --6229
        --Q7 21
        {"model", "models/items/meepo/meepo_skeletonkey_sword/meepo_skeletonkey_sword.vmdl"},
         --4912
        {"model", "models/items/meepo/meepo_skeletonkey_bandana/meepo_skeletonkey_bandana.vmdl"},
         --4911
        {"model", "models/items/meepo/meeposksh/meeposksh.vmdl"},
         --4914
        {"model", "models/items/meepo/meeposkback/meeposkback.vmdl"},
         --4913
        --299
        --300
        --W6 00
        {"model", "models/items/phantom_assassin/carreau_weapon/carreau_weapon.vmdl"},
         --7113
        {"model", "models/items/phantom_assassin/carreau_head/carreau_head.vmdl"},
         --7117
        {"model", "models/items/phantom_assassin/carreau_shoulder/carreau_shoulder.vmdl"},
         --7116
        {"model", "models/items/phantom_assassin/carreau_back/carreau_back.vmdl"},
         --7114
        {"model", "models/items/phantom_assassin/carreau_belt/carreau_belt.vmdl"},
         --7115
        --W6 10
        {"model", "models/items/phantom_assassin/dark_wraith_weapon/dark_wraith_weapon.vmdl"},
         --5354
        {"model", "models/items/phantom_assassin/dark_wraith_helmet/dark_wraith_helmet.vmdl"},
         --5352
        {"model", "models/items/phantom_assassin/dark_wraith_shoulder/dark_wraith_shoulder.vmdl"},
         --5353
        {"model", "models/items/phantom_assassin/dark_wraith_back/dark_wraith_back.vmdl"},
         --5350
        {"model", "models/items/phantom_assassin/dark_wraith_belt/dark_wraith_belt.vmdl"},
         --5351
        --W6 20
        {"model", "models/items/phantom_assassin/kiss_of_crows_weapon/kiss_of_crows_weapon.vmdl"},
         --8138
        {"model", "models/items/phantom_assassin/kiss_of_crows_head/kiss_of_crows_head.vmdl"},
         --8139
        {"model", "models/items/phantom_assassin/kiss_of_crows_shoulders/kiss_of_crows_shoulders.vmdl"},
         --8140
        {"model", "models/items/phantom_assassin/kiss_of_crows_back/kiss_of_crows_back.vmdl"},
         --8137
        {"model", "models/items/phantom_assassin/kiss_of_crows_belt/kiss_of_crows_belt.vmdl"},
         --8136
        --W6 21
        {
            "model",
        ...
        {"model", "models/heroes/phantom_assassin/pa_arcana_weapons.vmdl"},
         --7247
        --W7 00
        {"model", "models/heroes/enchantress/enchantress_weapon.vmdl"},
         --290
        {"model", "models/heroes/enchantress/enchantress_dress.vmdl"},
         --288
        {"model", "models/heroes/enchantress/enchantress_bracers.vmdl"},
         --289
        {"model", "models/heroes/enchantress/enchantress_hair.vmdl"},
         --287
        {"model", "models/heroes/enchantress/enchantress_weapon.vmdl"},
         --290
        --W7 10
        {"model", "models/items/enchantress/anuxi_wldkin_weapon2/anuxi_wldkin_weapon2.vmdl"},
         --4785
        {"model", "models/items/enchantress/anuxi_wldkin_hair2/anuxi_wldkin_hair2.vmdl"},
         --4786
        {"model", "models/items/enchantress/anuxi_wldkin_dress2/anuxi_wldkin_dress2.vmdl"},
         --4787
        {"model", "models/items/enchantress/anuxi_wildkin_neck/anuxi_wildkin_neck.vmdl"},
         --4678
        {"model", "models/items/enchantress/anuxi_wildkin_arm/anuxi_wildkin_arm.vmdl"},
         --4676
        --W7 20
        {"model", "models/items/enchantress/anuxi_summer_spear/anuxi_summer_spear.vmdl"},
         --5021
        {"model", "models/items/enchantress/anuxi_summer_head/anuxi_summer_head.vmdl"},
         --5024
        {"model", "models/items/enchantress/anuxi_summer_skirt/anuxi_summer_skirt.vmdl"},
         --5022
        {"model", "models/items/enchantress/anuxi_summer_shoulder/anuxi_summer_shoulder.vmdl"},
         --5023
        {"model", "models/items/enchantress/anuxi_summer_arms/anuxi_summer_arms.vmdl"},
         --5025
        --E3 00
        {"model", "models/items/ursa/wraps_of_the_radiant_protector/wraps_of_the_radiant_protector.vmdl"},
         --5893
        {"model", "models/items/ursa/belt_of_radiant_protector/belt_of_radiant_protector.vmdl"},
         --5888
        {"model", "models/items/ursa/mark_of_the_radiant_protector/mark_of_the_radiant_protector.vmdl"},
         --5894
        {"model", "models/items/ursa/braids_of_the_radiant_protector/braids_of_the_radiant_protector.vmdl"},
         --5893
        --E3 10
        {"model", "models/items/ursa/ursa_cryo_arms/ursa_cryo_arms.vmdl"},
         --5805
        {"model", "models/items/ursa/ursa_cryo_belt/ursa_cryo_belt.vmdl"},
         --5808
        {"model", "models/items/ursa/ursa_cryo_back/ursa_cryo_back.vmdl"},
         --5807
        {"model", "models/items/ursa/ursa_cryo_head/ursa_cryo_head.vmdl"},
         --5550
        --E3 11
        {"model", "models/items/ursa/fierce_heart_weapon/fierce_heart_weapon.vmdl"},
         --7654
        {"model", "models/items/ursa/fierce_heart_arms/fierce_heart_arms.vmdl"},
         --7651
        {"model", "models/items/ursa/fierce_heart_belt/fierce_heart_belt.vmdl"},
         --7650
        {"model", "models/items/ursa/fierce_heart_back/fierce_heart_back.vmdl"},
         --7652
        {"model", "models/items/ursa/fierce_heart_head/fierce_heart_head.vmdl"},
         --7653
        --E6 00
        {"model", "models/items/brewmaster/wep_brewmaster_cleaver_01/wep_brewmaster_cleaver_01.vmdl"},
         --4894
        {"model", "models/items/brewmaster/gear_brewmaster_sake_01/gear_brewmaster_sake_01.vmdl"},
         --4890
        {"model", "models/items/brewmaster/gear_brewmaster_gloves_01/gear_brewmaster_gloves_01.vmdl"},
         --4891
        {"model", "models/items/brewmaster/gear_brewmaster_back_01/gear_brewmaster_back_01.vmdl"},
         --4893
        {"model", "models/items/brewmaster/gear_brewmaster_shoulder_01/gear_brewmaster_shoulder_01.vmdl"},
         --4892
        --E6 10
        {"model", "models/items/brewmaster/reddragon_weapon/reddragon_weapon.vmdl"},
         --6969
        {"model", "models/items/brewmaster/reddragon_offhand/reddragon_offhand.vmdl"},
         --6968
        {"model", "models/items/brewmaster/reddragon_arms/reddragon_arms.vmdl"},
         --6967
        {"model", "models/items/brewmaster/reddragon_back/reddragon_back.vmdl"},
         --6966
        {"model", "models/items/brewmaster/reddragon_shoulder/reddragon_shoulder.vmdl"},
         --5641
        --D8 00
        {"model", "models/items/windrunner/wingsweapon2/wingsweapon2.vmdl"},
         --4552
        {"model", "models/items/windrunner/falconhelm1/falconhelm1.vmdl"},
         --4559
        {"model", "models/items/windrunner/falconcloak/falconcloak.vmdl"},
         --4554
        {"model", "models/items/windrunner/wingsshoulders2/wingsshoulders2.vmdl"},
         --4562
        {"model", "models/items/windrunner/featherquiver21/featherquiver21.vmdl"},
         --4553
        --D8 10
        {"model", "models/items/windrunner/tranquility_weapon/tranquility_weapon.vmdl"},
         --6835
        {"model", "models/items/windrunner/tranquility_head/tranquility_head.vmdl"},
         --6831
        {"model", "models/items/windrunner/tranquility_back/tranquility_back.vmdl"},
         --6836
        {"model", "models/items/windrunner/tranquility_shoulder/tranquility_shoulder.vmdl"},
         --6838
        {"model", "models/items/windrunner/tranquility_quiver/tranquility_quiver.vmdl"},
         --6837
        --R6 00
        {"model", "models/heroes/gyro/gyro_head.vmdl"},
         --131
        {"model", "models/heroes/gyro/gyro_guns.vmdl"},
         --177
        {"model", "models/heroes/gyro/gyro_goggles.vmdl"},
         --176
        {"model", "models/heroes/gyro/gyro_bottles.vmdl"},
         --126
        {"model", "models/heroes/gyro/gyro_propeller.vmdl"},
         --178
        {"model", "models/heroes/gyro/gyro_missile.vmdl"},
         --179
        --R6 10
        {"model", "models/items/gyrocopter/rainmaker_weapon/rainmaker_weapon.vmdl"},
         --6899
        {"model", "models/items/gyrocopter/rainmaker_head/rainmaker_head.vmdl"},
         --7121
        {"model", "models/items/gyrocopter/rainmaker_back/rainmaker_back.vmdl"},
         --6903
        {"model", "models/items/gyrocopter/rainmaker_misc/rainmaker_misc.vmdl"},
         --6898
        {"model", "models/items/gyrocopter/rainmaker_offhand/rainmaker_offhand.vmdl"},
         --6897
        --R6 11
        {"model", "models/items/gyrocopter/skyhigh_head/skyhigh_head.vmdl"},
         --7825
        {"model", "models/items/gyrocopter/skyhigh_back/skyhigh_back.vmdl"},
         --7823
        {"model", "models/items/gyrocopter/skyhigh_propeller/skyhigh_propeller.vmdl"},
         --7828
        {"model", "models/items/gyrocopter/skyhigh_bomb_missle/skyhigh_bomb.vmdl"},
         --7822
        --131
        {"model", "models/items/gyrocopter/immortal_guns/immortal_guns_gold.vmdl"},
         --9428
        --Q8 00

        {"model", "models/items/rattletrap/artisan_of_havoc_hook/artisan_of_havoc_hook.vmdl"},
         --6810
        {"model", "models/items/rattletrap/ironclock_head/ironclock_head.vmdl"},
         --7018
        {"model", "models/items/rattletrap/artisan_of_havoc_armor/artisan_of_havoc_armor.vmdl"},
         --6809
        {"model", "models/items/rattletrap/artisan_of_havoc_rocket/artisan_of_havoc_rocket.vmdl"},
         --6811
        --Q8 10
        ...
        {"model", "models/items/rattletrap/forge_warrior_rocket_cannon/forge_warrior_rocket_cannon.vmdl"},
         --6484
        --Q8 20
        {"model", "models/items/rattletrap/steelcrow_weapon/steelcrow_weapon.vmdl"},
         --9015
        {"model", "models/items/rattletrap/steelcrow_head/steelcrow_head.vmdl"},
         --9014
        {"model", "models/items/rattletrap/steelcrow_armor/steelcrow_armor.vmdl"},
         --9013
        {"model", "models/items/rattletrap/steelcrow_misc/steelcrow_misc.vmdl"},
         --9016
        --F7 00
        {"model", "models/heroes/alchemist/alchemist_scabbard.vmdl"},
         --118
        {"model", "models/heroes/alchemist/alchemist_shoulderbottles.vmdl"},
         --125
        {"model", "models/heroes/alchemist/alchemist_ogre_head.vmdl"},
         --124
        {"model", "models/heroes/alchemist/alchemist_goblin_body.vmdl"},
         --117
        {"model", "models/heroes/alchemist/alchemist_gauntlets.vmdl"},
         --120
        {"model", "models/heroes/alchemist/alchemist_goblinhat.vmdl"},
         --121
        {"model", "models/heroes/alchemist/alchemist_saddlehat.vmdl"},
         --119
        {"model", "models/heroes/alchemist/alchemist_goblin_head.vmdl"},
         --123
        --F7 10
        {"model", "models/items/alchemist/toxic_siege_blades/toxic_siege_blades.vmdl"},
         --6123
        {"model", "models/items/alchemist/toxic_siege_pauldrons/toxic_siege_pauldrons.vmdl"},
         --6122
        --124
        {"model", "models/items/alchemist/toxic_siege_garb/toxic_siege_garb.vmdl"},
         --6118
        {"model", "models/items/alchemist/toxic_siege_bracers/toxic_siege_bracers.vmdl"},
         --6117
        {"model", "models/items/alchemist/toxic_siege_safety_goggles/toxic_siege_safety_goggles.vmdl"},
         --6119
        {"model", "models/items/alchemist/toxic_siege_armored_saddle/toxic_siege_armored_saddle.vmdl"},
         --6121
        {"model", "models/items/alchemist/toxic_siege_corrosive_flasks/toxic_siege_corrosive_flasks.vmdl"},
         --6120
        --123

        --F8 00
        {"model", "models/items/dazzle/staff_of_the_yuwipi/staff_of_the_yuwipi.vmdl"},
         --5882
        {"model", "models/items/dazzle/band_of_summoning/band_of_summoning.vmdl"},
         --5879
        {"model", "models/items/dazzle/headdress_of_the_yuwipi/headdress_of_the_yuwipi.vmdl"},
         --5880
        {"model", "models/items/dazzle/bonedress_of_the_yuwipi/bonedress_of_the_yuwipi.vmdl"},
         --5881
        {"model", "models/heroes/dazzle/dazzle_shoulder.vmdl"},
         --468
        --F8 10
        {"model", "models/items/dazzle/dazzleset_weapon/dazzleset_weapon.vmdl"},
         --4685
        {"model", "models/items/dazzle/dazzleset_arm/dazzleset_arm.vmdl"},
         --4683
        {"model", "models/items/dazzle/dazzleset_back/dazzleset_back.vmdl"},
         --4682
        {"model", "models/items/dazzle/dazzleset_legs/dazzleset_legs.vmdl"},
         --4684
        {"model", "models/items/dazzle/dazzleset_misc/dazzleset_misc.vmdl"},
         --4681
        --banner badguys
        ...
        {"model", "models/heroes/ogre_magi/ogre_magi_bracers.vmdl"},
         --134
        --F9 10
        {"model", "models/items/ogre_magi/antipodean_weapon/antipodean_weapon.vmdl"},
         --7848
        {"model", "models/items/ogre_magi/antipodean_back/antipodean_back.vmdl"},
         --7845
        {"model", "models/items/ogre_magi/antipodean_head/antipodean_head.vmdl"},
         --7847
        {"model", "models/items/ogre_magi/antipodean_belt/antipodean_belt.vmdl"},
         --7846
        {"model", "models/items/ogre_magi/antipodean_arms/antipodean_arms.vmdl"},
         --7839
        --F9 11
        {"model", "models/items/ogre_magi/ogre_ancestral_weapon/ogre_ancestral_weapon.vmdl"},
         --5241
        {"model", "models/items/ogre_magi/ogre_ancestral_back/ogre_ancestral_back.vmdl"},
         --5243
        {"model", "models/items/ogre_magi/ogre_ancestral_head/ogre_ancestral_head.vmdl"},
         --5245
        {"model", "models/items/ogre_magi/ogre_ancestral_belt/ogre_ancestral_belt.vmdl"},
         --5244
        {"model", "models/items/ogre_magi/ogre_ancestral_arms/ogre_ancestral_arms.vmdl"},
         --5242
        --G7 00
        {"model", "models/items/antimage/wh_weapon/wh_weapon.vmdl"}, --4781
        {"model", "models/items/antimage/wh_offhand_weapon/wh_offhand_weapon.vmdl"},
         --4779
        {"model", "models/items/antimage/wh_mask/wh_mask.vmdl"},
         --4769
        {"model", "models/items/antimage/wh_armor/wh_armor.vmdl"},
         --4778
        {"model", "models/items/antimage/wh_arms/wh_arms.vmdl"},
         --4784
        {"model", "models/items/antimage/wh_belt/wh_belt.vmdl"},
         --4782
        {"model", "models/items/antimage/wh_shoulder/wh_shoulder.vmdl"},
         --4770
        --G7 10
        {"model", "models/items/antimage/reprieve_of_the_clergy_ascetic/reprieve_of_the_clergy_ascetic.vmdl"},
         --5531
        {
            "model",
         ...
         --5529
        {"model", "models/items/antimage/hood_of_the_clergy_ascetic/hood_of_the_clergy_ascetic.vmdl"},
         --5538
        {"model", "models/items/antimage/adornment_of_the_clergy_ascetic/adornment_of_the_clergy_ascetic.vmdl"},
         --5530
        {"model", "models/items/antimage/bracers_of_the_clergy_ascetic/bracers_of_the_clergy_ascetic.vmdl"},
         --5549
        {"model", "models/items/antimage/cloth_of_the_clergy_ascetic/cloth_of_the_clergy_ascetic.vmdl"},
         --5528
        {"model", "models/items/antimage/guard_of_the_clergy_ascetic/guard_of_the_clergy_ascetic.vmdl"},
         --5532
        --G7 11
        {"model", "models/items/antimage/tarrasque_scale_weapon/tarrasque_scale_weapon.vmdl"},
         --8611
        {"model", "models/items/antimage/tarrasque_scale_offhand/tarrasque_scale_offhand.vmdl"},
         --8678
        {"model", "models/items/antimage/tarrasque_scale_head/tarrasque_scale_head.vmdl"},
         --8596
        {"model", "models/items/antimage/tarrasque_scale_armor/tarrasque_scale_armor.vmdl"},
         --8595
        {"model", "models/items/antimage/tarrasque_scale_arms/tarrasque_scale_arms.vmdl"},
         --8610
        {"model", "models/items/antimage/tarrasque_scale_belt/tarrasque_scale_belt.vmdl"},
         --8609
        {"model", "models/items/antimage/tarrasque_scale_shoulder/tarrasque_scale_shoulder.vmdl"},
         --8620
        --G8 00
        {"model", "models/heroes/phantom_lancer/phantom_lancer_head.vmdl"},
         --127
        {"model", "models/items/phantom_lancer/weapon_kinship/weapon_kinship.vmdl"},
         --4439
        {"model", "models/items/phantom_lancer/shoulder_kinship/shoulder_kinship.vmdl"},
         --4451
        {"model", "models/items/phantom_lancer/arms_kinship/arms_kinship.vmdl"},
         --4402
        {"model", "models/items/phantom_lancer/belt_kinship/belt_kinship.vmdl"},
         --4409
        --G8 10
        {"model", "models/items/phantom_lancer/infinite_waves_serpent_weapon/infinite_waves_serpent_weapon.vmdl"},
         --6317
        {"model", "models/items/phantom_lancer/infinite_waves_shoulder/infinite_waves_shoulder.vmdl"},
         --6755
        {"model", "models/items/phantom_lancer/infinite_waves_arms/infinite_waves_arms.vmdl"},
         --6752
        {"model", "models/items/phantom_lancer/infinite_waves_belt/infinite_waves_belt.vmdl"},
         --6753
        --127

        --G8 11
        {"model", "models/items/phantom_lancer/sunwarrior_weapon/sunwarrior_weapon.vmdl"},
         --6620
        {"model", "models/items/phantom_lancer/sunwarrior_head/sunwarrior_head.vmdl"},
         --6621
        {"model", "models/items/phantom_lancer/sunwarrior_arms/sunwarrior_arms.vmdl"},
         --6619
        {"model", "models/items/phantom_lancer/sunwarrior_belt/sunwarrior_belt.vmdl"}
     --6617
    }
...
function CbtfGameMode:InitGameMode()
    ...
    GameRules:GetGameModeEntity():SetContextThink(
        ...
        function()
            if
                GameRules:State_Get() >= DOTA_GAMERULES_STATE_PRE_GAME and
                    GameRules:State_Get() < DOTA_GAMERULES_STATE_POST_GAME
             then
    ...
    GameRules:GetGameModeEntity():SetContextThink(
        ...
        function()
            for _, PlayerPosition in pairs(AllPlayers) do
                if
                    not PlayerS[PlayerPosition].Abandon and
                        PlayerResource:GetConnectionState(PlayerCalc:GetPlayerIDByPosition(PlayerPosition)) ==
...
function GetPlayerRankState(index, keys)
    ...
    local url =
        "http://www.dota2rpg.com/game_wz1/wz_get_ladderpoints.php?playerid=" ..
        keys.steamid .. "&hehe=" .. math.random()
        ...
        function(result)
            ...
            if keys then
                if keys.err ~= 1300 then
                    ...
                    PlayerS[PlayerPosition].ranking_level, PlayerS[PlayerPosition].ranking_appellation =
                        GetPlayerLevelAndAppellation(keys.score, playerrank, keys.per)
                end
            end
        end
    )
...
function ComputeAndSendPlayerStates()
    ...
    for _, i in pairs(AllPlayers) do
        ...
        MVP[i] =
            (count - damagetoking_rank[i]) * 11 + (count - killcount_rank[i]) * 8 + (count - breakgold_rank[i]) * 5 +
            (count - score_rank[i]) * 7 +
            (count - income_rank[i]) * 4 +
            (count - armaments_rank[i]) * 4
        if i <= 4 then
    ...
    for _, i in pairs(AllPlayers) do
        ...
        if _G.Rank_mode then
            ...
            rank_add_score[i] =
                rank_basic_score_s + rank_extra_score + math.abs(rank_extra_score) * rank_level_coefficient
...
function CbtfGameMode:DamageFilter(filterTable)
    ...
    if filterTable.entindex_victim_const and filterTable.entindex_attacker_const then
        ...
        if damaged_unit and source_unit then
            ...
            if
                GetAandDSystem(damaged_unit) and GetAandDSystem(source_unit) and
             ...
             then
                ...
                if source_hero then
                    if
                        source_unit:HasModifier("modifier_armament_24_buff") and
                            source_hero:HasItemInInventory("item_armament_24")
                     then
                        lifesteal2 = math.max(0.10, lifesteal2)
                    end
                    if
                        source_unit:HasModifier("modifier_armament_24_buff") and
                            source_hero:HasItemInInventory("item_armament_24_level2")
                     then
                        lifesteal2 = math.max(0.20, lifesteal2)
                    end
                    if
                        source_unit:HasModifier("modifier_armament_24_buff") and
                            source_hero:HasItemInInventory("item_armament_24_level3")
                     then
            ...
            if damaged_unit == king_left or damaged_unit == king_right then
                if source_unit:GetPlayerOwnerID() ~= -1 then
                    local PlayerPosition = PlayerCalc:GetPlayerPositionByID(source_unit:GetPlayerOwnerID())
                    PlayerS[PlayerPosition].MVP_DamageToKing =
                        PlayerS[PlayerPosition].MVP_DamageToKing + filterTable.damage
                end
            end
        end
...
function CbtfGameMode:OnGameRulesStateChange(keys)
    ...
    elseif newState == DOTA_GAMERULES_STATE_HERO_SELECTION then
        ...
        for i = 0, _G.PlayerCount - 1 do
            ...
            if PlayerResource:GetTeam(i) == DOTA_TEAM_BADGUYS then
                PlayerPosition2 = PlayerPosition2 + 1
                 --位置5-8
    ...
    elseif newState == DOTA_GAMERULES_STATE_GAME_IN_PROGRESS then
        ...
        for _, i in pairs(AllPlayers) do
            ...
            PlayerS[i].Lib =
                UnitManager:CreateUnitByName(
                "npc_dummy_lib",
                lib_ent:GetAbsOrigin(),
                false,
                pid,
                PlayerResource:GetTeam(pid)
            )
            PlayerS[i].Lib:SetControllableByPlayer(pid, true)
            PlayerS[i].Lib:SetContextThink(
                DoUniqueString("lib"),
                function()
            ...
            PlayerS[i].Pig =
                UnitManager:CreateUnitByName(
                "npc_dummy_pig",
                pig_ent:GetAbsOrigin(),
                false,
                pid,
                PlayerResource:GetTeam(pid)
            )
            PlayerS[i].Pig:SetControllableByPlayer(pid, true)
            PlayerS[i].Pig:SetContextThink(
                DoUniqueString("pig"),
                function()
            ...
            PlayerS[i].Banner:SetContextThink(
                DoUniqueString("banner"),
                function()
        ...
        GameRules:GetGameModeEntity():SetContextThink(
            ...
            function()
                if IsServer() then
                    if
                        GameRules:State_Get() == DOTA_GAMERULES_STATE_GAME_IN_PROGRESS or
                            GameRules:State_Get() == DOTA_GAMERULES_STATE_PRE_GAME
                     then
                        local now = GameRules:GetGameTime()
                        CustomGameEventManager:Send_ServerToAllClients(
                            "updateroundprogressbar",
                            {time = now - last_time, period = RoundThinker_Period}
                        )
                        RoundThinker(now)
...
function CbtfGameMode:OnNPCSpawned(keys)
    ...
    if trigger_unit_team_number == DOTA_TEAM_GOODGUYS then
        trigger_unit:SetForwardVector((Vector(2000, 0, 0) - Vector(-2000, 0, 0)):Normalized())
     --朝右
    end
    ...
    if trigger_unit:IsRealHero() == true then
        ...
        GameRules:GetGameModeEntity():SetContextThink(
            DoUniqueString("telepor_later"),
            function()
                FindClearSpaceForUnit(trigger_unit, PlayerS[PlayerPosition].StartPoint, true)
            end,
            0.1
        )
         --传送到开始点
...
function CbtfGameMode:InitPlayer(PlayerID, PlayerPosition)
    ...
    if PlayerS[PlayerPosition] == nil then --用位置来代替玩家ID
        ...
        --测试模式
        if _G.test_mode then
            PlayerS[PlayerPosition].Gold = 99999
...
function CbtfGameMode:OnPlayerReconnected(keys)
    ...
    if GameRules:State_Get() >= DOTA_GAMERULES_STATE_HERO_SELECTION then --判断是否进入了游戏
        ...
        if not PlayerS[PlayerPosition].Hero then
            PlayerS[PlayerPosition].Hero =
                CreateHeroForPlayer(GetRandomCommanderName(), PlayerResource:GetPlayer(nReconnectedPlayerID))
        else
        ...
        GameRules:GetGameModeEntity():SetContextThink(
            DoUniqueString("OnPlayerReconnected"),
            function()
